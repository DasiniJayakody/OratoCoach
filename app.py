...
# Check for required third-party packages and show an actionable message if missing
_missing = []
try:
...
if _missing:
    ...
    print("")
    print("Install them into your active virtualenv with:")
    print("    pip install -r requirements.txt")
    print("")
    print("If you don't have a virtualenv activated, create & activate one first:")
    print("    python -m venv .venv")
    print("    .venv\\Scripts\\activate    (on Windows PowerShell)")
    print("    source .venv/bin/activate  (on macOS / Linux)")
    sys.exit(1)

# Now it's safe to import the rest of the modules
from flask import Flask, render_template, request, jsonify, send_file
import cv2  # safe now
import mediapipe as mp
import numpy as np
